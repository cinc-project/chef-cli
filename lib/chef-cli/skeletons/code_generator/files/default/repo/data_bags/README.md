...
This directory contains directories of the various data bags you create for your infrastructure. Each subdirectory corresponds to a data bag on the Cinc Infra Server, and contains JSON files of the items that go in the bag.
...
Before uploading this item to the server, we must first create the data bag on the Cinc Infra Server.

    knife data bag create example

Then we can upload the items in the data bag's directory to the Cinc Infra Server.
